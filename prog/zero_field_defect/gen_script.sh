...
BOGTOL="0.025 0.025 0.025 0.025 0.025 0.025 0.025 0.025 0.025";
...
sed -i "" -e "s|#ITCLRANGE#|${iter_CL}|g" run_prog_temp;
sed -i "" -e "s|#PLRUNS#|${PLRUNS}|g" run_prog_temp;
sed -i "" -e "s|#ITDSRANGE#|${iter_DS}|g" run_prog_temp;
sed -i "" -e "s|#PARXRANGE#|${PAR_X}|g" run_prog_temp;
sed -i "" -e "s|#DSWDRANGE#|${DIS_WDTH}|g" run_prog_temp;
sed -i "" -e "s|#JPRANGE#|${JP_WDTH}|g" run_prog_temp;
sed -i "" -e "s|#IPRMIN#|${IMIN}|g" run_prog_temp;
sed -i "" -e "s|#IPRMAX#|${IMAX}|g" run_prog_temp;
sed -i "" -e "s|#IPRGRID#|${IGRID}|g" run_prog_temp;
sed -i "" -e "s|#FREQMIN#|${MINF}|g" run_prog_temp;
sed -i "" -e "s|#FREQMAX#|${MAXF}|g" run_prog_temp;
sed -i "" -e "s|#WGRID#|${FREQNUM}|g" run_prog_temp;
sed -i "" -e "s|#XMOMIN#|${XMINMO}|g" run_prog_temp;
sed -i "" -e "s|#XMOMAX#|${XMAXMO}|g" run_prog_temp;
sed -i "" -e "s|#XKGRID#|${XMOMNUM}|g" run_prog_temp;
sed -i "" -e "s|#YMOMIN#|${YMINMO}|g" run_prog_temp;
sed -i "" -e "s|#YMOMAX#|${YMAXMO}|g" run_prog_temp;
sed -i "" -e "s|#YKGRID#|${YMOMNUM}|g" run_prog_temp;
sed -i "" -e "s|#LST#|${LIST}|g" run_prog_temp;
sed -i "" -e "s|#STR#|${STRFC}|g" run_prog_temp;
sed -i "" -e "s|#VCT#|${vcut}|g" run_prog_temp;
sed -i "" -e "s|#HCT#|${hcut}|g" run_prog_temp;
sed -i "" -e "s|#BTL#|${BOGTOL}|g" run_prog_temp;
sed -i "" -e "s|#GTL#|${GTOL}|g" run_prog_temp;
sed -i "" -e "s|#THETADWIDTH#|${ANGDWIDTH}|g" run_prog_temp;
sed -i "" -e "s|#EIGNUM#|${EIGNUM}|g" run_prog_temp;
sed -i "" -e "s|#QMX#|${QMX}|g" run_prog_temp;
sed -i "" -e "s|#QMY#|${QMY}|g" run_prog_temp;
sed -i "" -e "s|#WM#|${WM}|g" run_prog_temp;
sed -i "" -e "s|#BIN#|${EXEC}|g" run_prog_temp;
