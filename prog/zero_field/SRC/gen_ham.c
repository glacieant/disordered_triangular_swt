...
// This program generates the classical hamiltonian
...
// This program computes the mean field parameters
...
void mf_angles(int N_lattpoint,lattpoint *lsite,double **J,
	...
	// setting up the matrix vector linear system
...
#pragma omp for
		for (i=0;i<N_lattpoint;i++) {
			...
			for (j=0;j<ZCO;j++) {
				...
				// Setting up the right hand vector of the equation
				...
				// contribution from the derivative of the neighbouring spin angle
				...
				// contribution for self derivative
			...
			// Setting up the left hand matrix of the equation
	...
	// performing the svd for inverting the matrix
